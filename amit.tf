...
resource "aws_s3_bucket_object" "s3object" {
  ...
  key    = "Hy.jpg"
  source = "C:/Users/Amit/Downloads/Hy.jpg"
}
...
resource "aws_instance" "os" {
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("C:/Users/Amit/Downloads/amitkey.pem")
...
resource "null_resource" "null1"  {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/amit17133129/newjen.git /var/www/html/"
    ]
  }
}